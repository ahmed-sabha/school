      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-8 order-md-2 mb-5">
            <div class="row">
              <div class="col-md-12">
                <img src="web_assets/images/img_2.jpg" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row bg-light align-items-center p-4 episode">
          ...
          <div class="col-md-6 col-lg-4 order-md-1">
            ...
            <div class="block-28 text-center mb-5">
              <figure>
                <img src="web_assets/images/person_3.jpg" alt="" class="img-fluid">
              </figure>
                ...
                <li>
                  <a href="#" class="d-flex">
                    <figure class="image mr-3">
                      <img src="web_assets/images/img_2_b.jpg" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
      ...
      <div class="container-fluid block-11 element-animate">
        <div class="nonloop-block-11 owl-carousel">
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="web_assets/images/img_1.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="web_assets/images/img_2.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
