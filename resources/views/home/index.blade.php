...
@section('content')
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(web_assets/images/big_image_2.jpg);">
      <div class="container">
        <div class="row align-items-center justify-content-center site-hero-inner">
          <div class="col-md-10">
            ...
            <div class="mb-5 element-animate">
              <div class="block-17">
                <h2 class="heading text-center mb-4">{{__('website.find oneline courses that suits you')}}</h2>
                <form action="" method="post" class="d-block d-lg-flex mb-4">
                    @csrf
                  <div class="fields d-block d-lg-flex">
                    <div class="textfield-search one-third"><input type="text" class="form-control" placeholder="{{__('website.keyword search')}}..."></div>
                    <div class="select-wrap one-third">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      <select name="" id="" class="form-control">
                        <option value="">{{__('website.category course')}}</option>
                    ...
                    <div class="select-wrap one-third">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      <select name="" id="" class="form-control">
                        <option value="">{{__('website.difficulty')}}</option>
                  ...
                  <input type="submit" class="search-submit btn btn-primary" value="{{__('website.search')}}">
                </form>
                <p class="text-center mb-5">{{__('website.we have more than 500 courses to improve your skills')}}</p>
                <p class="text-center"><a href="#" class="btn py-3 px-5">{{__('cp.register now')}}</a></p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="web_assets/images/img_1.jpg" alt="Image placeholder" class="img-fluid">
    ...
    <section class="site-section bg-light element-animate" id="section-counter">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <figure><img src="web_assets/images/img_2_b.jpg" alt="Image placeholder" class="img-fluid"></figure>
          </div>
          <div class="col-lg-5 ml-auto">
            <div class="block-15">
              <div class="heading">
                <h2>{{__('cp.Education is Life')}}</h2>
              </div>
              <div class="text mb-5">
     ...
     <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-7 text-center section-heading">
            <h2 class="text-primary heading">{{__('cp.courses')}}</h2>
      ...
      <div class="container-fluid block-11 element-animate">
        <div class="nonloop-block-11 owl-carousel">
          ...
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="web_assets/images/img_3.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <h2 class="heading"><a href="#">{{$item->title}}</a></h2>
                  <p class="mb-4">{{$item->subtitle}}</p>
                  <div class="meta d-flex align-items-center">
                    <div class="number">
                      <span>{{$item->views}}</span>
                    </div>
                    <div class="price text-right"><del class="mr-3">{{$item->price}}</del><span>Free</span></div>
                  </div>
                </div>
              </div>
          </div>
    ...
    <div class="container site-section element-animate">
      <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center section-heading">
            <h2 class="text-primary heading">{{__('cp.teachers')}}</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
          </div>
        </div>
      <div class="row">
        @foreach ($teac as $item)
        <div class="col-md-6 col-lg-4">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(../web_assets/images/person_3.jpg);">
                <div class="box">
                  <h2>{{$item->name}}</h2>
                  <p>{{$item->job}}</p>
                </div>
              ...
              <div class="back">
                <!-- back content -->
                <blockquote>
                  <p>&ldquo;{{$item->subtitle}}&rdquo;</p>
                </blockquote>
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="web_assets/images/person_3.jpg" alt="">
                  </div>
                  <div class="name align-self-center">{{$item->name}} <span class="position">{{$item->job}}</span></div>
                </div>
              </div>
            </div>
          </div> <!-- .flip-container -->
...
@endforeach
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-7 text-center section-heading">
            <h2 class="text-primary heading">{{__("cp.blog")}}</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
          </div>
        </div>
        <div class="row element-animate">
          ...
          <div class="col-md-12 mb-5 mb-lg-0 col-lg-6">
            ...
            <div class="block-20 ">
              <figure>
                <a href="#"><img src="web_assets/images/img_1.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
          ...
          <div class="col-md-12 col-lg-6">
            ...
            <div class="block-21 d-flex mb-4">
              ...
              <div class="text">
                ...
                <div class="meta">
                  <div><a href="#"><span class="ion-android-calendar"></span>{{$item->updated_at}}</a></div>
                  <div><a href="#"><span class="ion-android-person"></span> {{$item->name_admin}}</a></div>
                  <div><a href="#"><span class="ion-chatbubble"></span>{{$item->count_comments}}</a></div>
                </div>
              </div>
            </div>
             @endforeach
