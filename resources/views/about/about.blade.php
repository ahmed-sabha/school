    ...
    <div class="container site-section element-animate">
      ...
      <div class="block-3 d-md-flex pt-5">
        <div class="image" style="background-image: url('web_assets/images/img_1.jpg'); "></div>
        <div class="text">
      ...
      <div class="block-3 d-md-flex">
        <div class="image order-2" style="background-image: url('web_assets/images/img_2.jpg'); "></div>
      ...
      <div class="block-3 d-md-flex">
        <div class="image" style="background-image: url('web_assets/images/img_3.jpg'); "></div>
        <div class="text">
          <h4 class="subheading">Nice text here</h4>
